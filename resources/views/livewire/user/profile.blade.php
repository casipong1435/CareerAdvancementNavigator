        ...
        <div class="toggle-container d-flex justify-content-between">
            ...
            <div class="button-holder d-flex flex-row">
                @if ($accountSetting == 0)
                    ...
                    <input type="reset" value="CANCEL" class="profile-cancel-button px-3 py-1 mx-1 rounded {{ $state == 0 ? 'd-none':'' }}" wire:click="changeState({{0}})">
                    ...
                    <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="date" wire:model="date_started_in_deped" placeholder="Date Started in Deped" class="w-100 p-2 " {{ $state == 1 ? '':'disabled' }}>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <select wire:model.live="district" id="district_option" class="w-100 p-2" {{ $state == 1 ? '':'disabled' }}>
